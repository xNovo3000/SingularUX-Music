...
public class ListenPlaybackInfoUseCase {
    ...
    @Inject
    public ListenPlaybackInfoUseCase(MusicControllerFacade musicControllerFacade) {
    ...
    private static class PlaybackInfoListener implements Player.Listener {
        ...
        public void update() {
            ...
            // Check for availability of mediaItem
            if (mediaItem == null) {
                Log.d(TAG, "Timeline is empty, sending empty PlaybackInfo");
            ...
            if (mediaItem.mediaMetadata.extras != null &&
                ...
                playbackToken = mediaItem.mediaMetadata.extras.getString("playing_from");
            }
            // Artwork
            ...
            PlaybackInfo playbackInfo = new PlaybackInfo(id, title, artistId, artistName,
                    albumId, albumTitle, duration, artworkUri, playbackToken);
            Log.d(TAG, "Sending " + playbackInfo);
